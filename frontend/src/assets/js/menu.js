jQuery(document).ready(function () {
	...
	function stickyNav() {
		var scrollTop = $(window).scrollTop(),
			...
			headerOpacityLgNosticky = $(
				".viewport-lg.header-opacity.no-sticky"
			),
	...
	if ($(".navik-header-overlay").length) {
		var navikHeaderOverlay = $(".navik-header-overlay"),
			...
			menuOverlayListDropdown = $(
				".navik-menu-overlay > ul > li:has(ul)"
			),
			menuOverlayLink = $(".navik-menu-overlay > ul > li > a"),
			menuSlide = $(".navik-header-overlay.menu-slide"),
			menuSlideSubmenuLink = menuSlide.find(
				".navik-menu-overlay > ul ul a"
			),
		...
		menuOverlayListDropdown.each(function () {
			var menuOverlayDropdownLink =
				$(this).children(".menu-overlay-link");
		...
		submenuVerticalListItem.each(function () {
			var submenuVerticalDropdownLink =
				$(this).children(".menu-overlay-link");
